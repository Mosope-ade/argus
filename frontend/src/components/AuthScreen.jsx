...
export default function AuthScreen({ login, loading, error }) {
    ...
    <div className="h-screen bg-[#080c12] flex items-center justify-center">
      <div className="w-full max-w-md border border-[#1a2535] bg-[#0d1117] p-8">
        ...
        <button
          ...
          disabled={loading}
          className="w-full mt-4 border border-[#00d4ff] text-[#00d4ff] p-3 font-mono hover:bg-[#00d4ff] hover:text-[#080c12] transition-colors disabled:opacity-50"
        >
